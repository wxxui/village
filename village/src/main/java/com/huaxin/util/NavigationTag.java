...
public class NavigationTag extends TagSupport {
     ...
     */
    private String resolveUrl(String url, javax.servlet.jsp.PageContext pageContext) throws JspException, UnsupportedEncodingException{
    	...
    	for (Object key:params.keySet()) {
    		...
    		//拼接url时，customerName参数先转为utf-8，然后浏览器转为iso-8859，然后再在controller中再次转为utf-8。
    		if (value.getClass().isArray()) {
    			url = append(url, key.toString(), new String(((String[])value)[0].toString().getBytes("iso8859-1"), "utf-8"));
